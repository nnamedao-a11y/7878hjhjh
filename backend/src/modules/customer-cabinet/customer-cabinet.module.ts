...
import { CustomerCabinetController, CabinetHistoryController } from './customer-cabinet.controller';
...
@Module({
  imports: [
    MongooseModule.forFeature([
      ...
      { name: 'HistoryReport', schema: HistoryReportSchema },
    ]),
  ],
  controllers: [CustomerCabinetController, CabinetHistoryController],
